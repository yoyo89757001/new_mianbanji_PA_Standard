...
import megvii.testfacepass.pa.utils.DensityUtil;
...
public class MianBanJiView extends View{
    ...
    private void initData(){
        ...
        kuangPaint2.setColor(Color.parseColor("#66ffffff"));
        ...
        kuangPaint3.setColor(Color.parseColor("#66000000"));
...
//        paintYuanHuan2.setStrokeCap(Paint.Cap.ROUND);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isStart){
            ...
            canvas.drawText("瑞瞳智能科技",viewW-pp-10,viewH-12,ziPaint2);
            if (isTiShi){
