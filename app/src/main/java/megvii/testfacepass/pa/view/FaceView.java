...
//        smiles = new ArrayList<>();
        ...
        idPaint.setARGB(244, 80, 80, 80);
        idPaint.setTextSize(30);

        posePaint.setARGB(255, 80, 80, 80);
        posePaint.setTextSize(50);
    }
...
//        smiles.clear();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //    canvas.drawRect(r.right+5, r.top - 5, r.right + 150, r.top + 120, backPaint);
          //  canvas.drawText("微笑值:", r.right + 15, r.top + 30, idPaint);
          //  String wx =  ids.get(i);

          //  canvas.drawText(wx, r.right + 5, r.top + 82, posePaint);
