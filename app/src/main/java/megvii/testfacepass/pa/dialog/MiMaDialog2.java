 ...
 * @author Tom.Cai
 */
public class MiMaDialog2 extends Dialog implements View.OnClickListener {
    ...
    public MiMaDialog2(Context context, int mima) {
        super(context, R.style.dialog_style33);
    ...
    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.mima_item2, null);
