 ...
 * @author Tom.Cai
 */
public class MiMaDialog3 extends Dialog implements View.OnClickListener {
    ...
    private void setCustomDialog() {
        View mView = LayoutInflater.from(getContext()).inflate(R.layout.mima_item3, null);
