...
class FxTool3399 implements FxTool.IFxTool { 
	public FxTool3399() { 
	}
	...
	private static final int GPIO_DOOR_GPIO1 = 53;
	private static final int GPIO_DOOR_GPIO2 = 54; 
	private static final int GPIO_DOOR_CONTROL = 34; 
	private static final int GPIO_FLASH_LIGHT = 133;
	private static final int GPIO_CPU_FAN = 33;
	private static final int GPIO_LED1_CONTROL = 35;
	private static final int GPIO_LED2_CONTROL = 36;
	private static final int GPIO_LED3_CONTROL = 37;
	private static final int GPIO_LIGHT_SENSOR = 158; 
