...
public class CameraManager2 implements CameraPreview2.CameraPreviewListener2 {
    ...
    private CameraListener2 listener = null;
...
//                        previewRotation = 90;
    ...
    public boolean open(WindowManager windowManager, int front) {
        if (state == CameraState.OPENING) {
            return false;
        }
        this.front = front;
    ...
    public void setPreviewDisplay(CameraPreview2 preview) {
        this.cameraPreview = preview;
        this.surfaceHolder = preview.getHolder();
        preview.setListener(this);
    }

    public void setListener(CameraListener2 listener) {
    ...
    public interface CameraListener2 {
        void onPictureTaken2(CameraPreviewData2 cameraPreviewData);
    }
}
